    ...
    observe({
        ...
        leafletProxy('PointsMap') %>%
            ...
            addCircleMarkers(
                ...
                popup = paste(paste0('<center><img src="', FatalSub$photo, '" height=100px ></img></center> <br>', 
                                     '<strong>Name: </strong>', FatalSub$subject_name, '<br>',
                                     '<strong>Age: </strong>', FatalSub$subject_age, '<br>',
                                     '<strong>Gender: </strong>', FatalSub$subject_gender, '<br>',
                                     '<strong>Incident Date: </strong>', FatalSub$date_injury, '<br>',
                                     '<strong>Cause: </strong>', FatalSub$cause_of_death, '<br>',
                                     '<strong>Location: </strong>', FatalSub$city, ' ', FatalSub$state, '<br>',
                                     '<strong>Link: </strong>', '<a href="', FatalSub$link, '">', FatalSub$link, '</a>', '<br>'
                ))
            ) %>%
